...
HD_PWD='C:/Users/PC/FPU/FPU.runs/blk_mem_gen_RAM_FPGA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_RAM_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_RAM_FPGA.tcl
